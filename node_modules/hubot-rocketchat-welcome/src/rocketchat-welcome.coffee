...
localList = require('./lang.json').words;
...
warnMessage = process.env.WARN_MESSAGE or "Any inappropirate language or hate shall not be tolerated in any pips masters channel, failure to comply you will be permanently banned from the community"
...
module.exports = (robot) ->
  ...
  #   robot.logger.info "............1, #{robot.brain.get('welcomed_users')}"
  ...
  warnUser = (msg) ->
    user = getUser(msg)
    msg.send "@#{msg.message.user.name}, #{warnMessage}"
