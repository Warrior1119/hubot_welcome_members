...
module.exports = (robot) ->
  ...
  warnUser = (msg) ->
    user = getUser(msg)
    msg.send "@#{msg.message.user.name}, Any inappropirate language or hate shall not be tolerated in any pips masters channel, failure to comply you will be permanently banned from the community"
